...
function InitiateSideMenu() {
    ...
    $("#sidebar-collapse").on("click", function () {
        if ($("#sidebar").is(":visible") || $("#sidebar").toggleClass("hide"),
                ...
                $(".sidebar-menu").closest("div").hasClass("slimScrollDiv") && ($(".sidebar-menu").slimScroll({destroy: !0}),
            ...
            $(".sidebar-menu").slimscroll({height: "auto", position: t, size: "3px", color: themeprimary})
        }
    });
...
function InitiateSettings() {
    if (readCookie("navbar-fixed-top") != null && readCookie("navbar-fixed-top") == "true" && ($("#checkbox_fixednavbar").prop("checked", !0), $(".navbar").addClass("navbar-fixed-top")), readCookie("sidebar-fixed") != null && readCookie("sidebar-fixed") == "true" && ($("#checkbox_fixedsidebar").prop("checked", !0), $(".page-sidebar").addClass("sidebar-fixed"), !$(".page-sidebar").hasClass("menu-compact"))) {
        ...
        $(".sidebar-menu").slimscroll({height: $(window).height() - 90, position: n, size: "3px", color: themeprimary})
    }
...
function setCookiesForFixedSettings() {
    ...
    }) : $(".sidebar-menu").closest("div").hasClass("slimScrollDiv") && ($(".sidebar-menu").slimScroll({destroy: !0}), $(".sidebar-menu").attr("style", ""))
}
function getcolor(n) {
    switch (n) {
        case"themeprimary":
...
additionalHeight = 0;
$(window).width() < 531 && (additionalHeight = 45);
