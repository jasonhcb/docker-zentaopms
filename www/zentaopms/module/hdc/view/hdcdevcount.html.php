  ...
  <div class='col-md-3 col-lg-2'>
    <div class='panel panel-sm'>
      ...
      <div class='panel-body' style='padding-top:0'>
        <form method='post'>
          <?php echo html::checkBox('charts', $lang->hdc->report->charts, $checkedCharts, '', 'block')?>
        ...
        <tr class='text-top'>
          <td>
            <div class='chart-wrapper text-center'>
              <h5><?php echo $lang->hdc->report->charts[$chartType];?></h5>
              ...
              <table class='table table-condensed table-hover table-striped table-bordered table-chart' data-chart='<?php echo $chartOption->type; ?>' data-target='#chart-<?php echo $chartType ?>' data-animation='false'>
                <thead>
                  <tr>
                    ...
                    <th><?php echo $lang->hdc->report->value;?></th>
                    <th><?php echo $lang->hdc->report->menber;?></th>
                  </tr>
                </thead>
                <tbody>
                ...
                <tr class='text-center'>
                  ...
                  <td class='chart-value'><?php echo $data->devalue;?></td>
                  <td class='chart-manday'><?php echo $data->manday;?></td>
                </tr>
                <?php endforeach;?>
                </tbody>
              </table>
